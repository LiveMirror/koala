package org.openkoala.organisation.applicationImpl;
...
public class OrganizationApplicationImpl implements OrganizationApplication {
    ...
    @BLMapping("OrganizationApplicationImpl.createAsTopOrganization")
	@Override
	public void createAsTopOrganization(Company company) {
		company.createAsTopOrganization();
	}

    @BLMapping("OrganizationApplicationImpl.createCompany")
	@Override
    ...
    @BLMapping("OrganizationApplicationImpl.assignChildOrganization")
    @Override
    ...
    @BLMapping("OrganizationApplicationImpl.getOrganizationTree")
	@Override
    ...
    @BLMapping("OrganizationApplicationImpl.createDepartment")
    @Override
