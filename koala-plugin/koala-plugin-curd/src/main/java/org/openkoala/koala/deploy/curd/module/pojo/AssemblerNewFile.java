 ...
 */
public class AssemblerNewFile extends NewFile {
	...
	private static final String TEMPLATE_PATH = "templates/assemblerTemplate.vm";
     ...
     * @param type
     */
    public AssemblerNewFile(String name, List<MavenProject> projects, NewFileType type, MavenProject project, EntityModel entityModel) {
    ...
    public void process() {
        ...
        context.put("assemblerClass", this);
    ...
    public String getPackageName() {
    	...
    	return super.getPackageName()  + ".assembler";
    }
