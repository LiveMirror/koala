 ...
 */
public class FacadeImplNewFile extends NewFile {
    ...
    private static final String TEMPLATE_PATH = "templates/facadeImplTemplate.vm";
     ...
     * @param type
     */
    public FacadeImplNewFile(String name, List<MavenProject> projects, NewFileType type,EntityModel entityModel,EntityViewUI entityViewUI) {
