...
public class GitlabHTTPRequestor {
     ...
     * <p/>
     * Has a fluent org.gitlab.api for method chaining.
     *
     * @param method The HTTP method
     * @return this
     */
    public org.gitlab.api.http.GitlabHTTPRequestor method(String method) {
        try {
     ...
     * @return this
     */
    public org.gitlab.api.http.GitlabHTTPRequestor with(String key, Object value) {
    ...
    public <T> Iterator<T> asIterator(final String tailApiUrl, final Class<T> type) {
        ...
        return new Iterator<T>() {
            ...
            private void findNextUrl(HttpURLConnection connection) throws MalformedURLException {
                 ...
                 * The Gitlab API is not a compliant hypermedia REST org.gitlab.api, so we use
